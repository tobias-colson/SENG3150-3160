...
<div id="container">
	...
	<div class="filter">
		...
		<form name="filter" method="post" action="/filterreturn">
			...
			<input type="hidden" name="assisted" value="${assisted}"/>
			<input type="hidden" name="usercategory" value="${usercategory}"/>
			<input type="hidden" name="departing" value="${departing}"/>

			<input type="hidden" name="airlineName" value="${depflight.airlineName}"/>
			<input type="hidden" name="airlineCode" value="${depflight.airlineCode}"/>
			<input type="hidden" name="flightNumber" value="${depflight.flightNumber}"/>
			<input type="hidden" name="departure_airport" value="${depflight.departure_airport}"/>
			<input type="hidden" name="arrival_airport" value="${depflight.arrival_airport}"/>
			<input type="hidden" name="duration" value="${depflight.duration}"/>
			<input type="hidden" name="stop_overs" value="${depflight.stop_overs}"/>
			<input type="hidden" name="cost" value="${depflight.cost}"/>
			<input type="hidden" name="depdate" value="${depflight.depdate}"/>
			<input type="hidden" name="class_type" value="${depflight.class_type}"/>
			<input type="hidden" name="plane_code" value="${depflight.plane_code}"/>
			<input type="hidden" name="dep_time" value="${depflight.dep_time}"/>
			<input type="hidden" name="arr_date" value="${depflight.arr_date}"/>
			<input type="hidden" name="arr_time" value="${depflight.arr_time}"/>
			<input type="hidden" name="stopover_airport" value="${depflight.stopover_airport}"/>
			<input type="hidden" name="stopover_arrtime" value="${depflight.stopover_arrtime}"/>
			<input type="hidden" name="stopover_deptime" value="${depflight.stopover_deptime}"/>
			<input type="hidden" name="departureTime" value="${depflight.departureTime}"/>
			<input type="hidden" name="display" value="${depflight.display}"/>
	...
	<div id="body">
		<c:choose>
			<c:when test ="${departing == true}">
				<div id="flights">
					<h2 id="results">Select A Departing Flight</h2>
			<form name="sorting" method="post" action="/sortreturn">
				...
				<input type="hidden" name="airlineName" value=""/>
				...
				<input type="hidden" name="stop_overs" value="0"/>
				<input type="hidden" name="cost" value="0"/>
				<input type="hidden" name="depdate" value=""/>
				<input type="hidden" name="class_type" value=""/>
				<input type="hidden" name="plane_code" value=""/>
				<input type="hidden" name="dep_time" value=""/>
				<input type="hidden" name="arr_date" value=""/>
				<input type="hidden" name="arr_time" value=""/>
				<input type="hidden" name="stopover_airport" value=""/>
				<input type="hidden" name="stopover_arrtime" value=""/>
				<input type="hidden" name="stopover_deptime" value=""/>
				...
				<div class="details">
				<form name="details" method="post" action="/returning">
			...
			<c:otherwise>
				<div id="flights">
					<h2 id="results">Select A Returning Flight</h2>
					<form name="sorting" method="post" action="/sortreturn">
						<select onchange="this.form.submit()" name="sorting_method" id="sorting_method2">
							<c:choose>
								<c:when test="${sortoption == 'none'}">
									<option value="none" selected="selected">Select Sorting Option</option>
								</c:when>
					...
					<c:forEach var="flight" items="${retflights}" >
						<div class="details">
							<form name="details" method="post" action="/booking">
								...
								<input type="hidden" name="airlineName2" value="${depflight.airlineName}"/>
								<input type="hidden" name="airlineCode2" value="${depflight.airlineCode}"/>
								<input type="hidden" name="flightNumber2" value="${depflight.flightNumber}"/>
								<input type="hidden" name="departure_airport2" value="${depflight.departure_airport}"/>
								<input type="hidden" name="arrival_airport2" value="${depflight.arrival_airport}"/>
								<input type="hidden" name="duration2" value="${depflight.duration}"/>
								<input type="hidden" name="stop_overs2" value="${depflight.stop_overs}"/>
								<input type="hidden" name="cost2" value="${depflight.cost}"/>
								<input type="hidden" name="depdate2" value="${depflight.depdate}"/>
								<input type="hidden" name="class_type2" value="${depflight.class_type}"/>
								<input type="hidden" name="plane_code2" value="${depflight.plane_code}"/>
								<input type="hidden" name="dep_time2" value="${depflight.dep_time}"/>
								<input type="hidden" name="arr_date2" value="${depflight.arr_date}"/>
								<input type="hidden" name="arr_time2" value="${depflight.arr_time}"/>
								<input type="hidden" name="stopover_airport2" value="${depflight.stopover_airport}"/>
								<input type="hidden" name="stopover_arrtime2" value="${depflight.stopover_arrtime}"/>
								<input type="hidden" name="stopover_deptime2" value="${depflight.stopover_deptime}"/>
								<input type="hidden" name="departureTime2" value="${depflight.departureTime}"/>
								<input type="hidden" name="display2" value="${depflight.display}"/>
